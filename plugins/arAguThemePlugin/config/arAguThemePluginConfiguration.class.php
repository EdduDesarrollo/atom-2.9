...
class arAguThemePluginConfiguration extends sfPluginConfiguration
{
    ...
    public function initialize()
    {
        ...
        if (false !== $key = array_search('arAguThemePlugin', $plugins)) {
            unset($plugins[$key]);
        }
        $this->configuration->setPlugins(
            array_merge(['arAguThemePlugin'], $plugins)
        );
