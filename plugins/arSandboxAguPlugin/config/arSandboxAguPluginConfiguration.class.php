...
class arSandboxAguPluginConfiguration extends sfPluginConfiguration
{
    public static $summary = 'Theme sandbox Agu: variante de arDominion con header naranja y ajustes de color.';
    public static $version = '0.0.1-sandbox';
    ...
    public function contextLoadFactories(sfEvent $event)
    {
        ...
        if ($context->getConfiguration()->isDebug()) {
            ...
            $context->response->addStylesheet('/plugins/arSandboxAguPlugin/css/main.less', 'last', ['rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all']);
        } else {
            $context->response->addStylesheet('/plugins/arSandboxAguPlugin/css/main.css', 'last', ['media' => 'all']);
        }
    }
